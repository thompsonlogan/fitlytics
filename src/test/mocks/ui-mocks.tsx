...
export const badgeMock = {
  Badge: function Badge({
    ...
    return (
      <span {...withSlot("badge", { className, ...props })}>{children}</span>
    )
  },
...
function makeDivMock(slot: string) {
  return function CardSlot({
    ...
    return (
      <div {...withSlot(slot, { className, ...props })}>{children}</div>
    )
  }
}
...
export const dropdownMenuMock = {
  ...
  DropdownMenuTrigger: function DropdownMenuTrigger({
    ...
    return (
      <button {...withSlot("dropdown-menu-trigger", { className, ...props })}>
        {children}
      </button>
    )
  },
  ...
  DropdownMenuItem: function DropdownMenuItem({
    ...
    return (
      <div
        role="menuitem"
        {...withSlot("dropdown-menu-item", { className, ...props })}
      >
        {children}
      </div>
    )
  ...
  DropdownMenuSeparator: function DropdownMenuSeparator({
    ...
    return (
      <div
        role="separator"
        {...withSlot("dropdown-menu-separator", { className, ...props })}
      />
    )
  },
  DropdownMenuShortcut: function DropdownMenuShortcut({
    ...
    return (
      <span {...withSlot("dropdown-menu-shortcut", { className, ...props })}>
        {children}
      </span>
    )
  },
  ...
  DropdownMenuSubTrigger: function DropdownMenuSubTrigger({
    ...
    return (
      <div
        role="menuitem"
        {...withSlot("dropdown-menu-sub-trigger", { className, ...props })}
      >
        {children}
      </div>
    )
...
export const inputMock = {
  Input: function Input({
    ...
    return (
      <input
        type={type}
        {...withSlot("input", { className, ...props })}
      />
    )
  },
}
...
export const tableMock = {
  ...
  TableHeader: function TableHeader({
    ...
    return (
      <thead {...withSlot("table-header", { className, ...props })}>
        {children}
      </thead>
    )
  },
  TableBody: function TableBody({
    ...
    return (
      <tbody {...withSlot("table-body", { className, ...props })}>
        {children}
      </tbody>
    )
  },
  TableFooter: function TableFooter({
    ...
    return (
      <tfoot {...withSlot("table-footer", { className, ...props })}>
        {children}
      </tfoot>
    )
  },
  TableHead: function TableHead({
    ...
    return (
      <th {...withSlot("table-head", { className, ...props })}>{children}</th>
    )
  },
  TableRow: function TableRow({
    ...
    return (
      <tr {...withSlot("table-row", { className, ...props })}>{children}</tr>
    )
  },
  TableCell: function TableCell({
    ...
    return (
      <td {...withSlot("table-cell", { className, ...props })}>{children}</td>
    )
  },
  TableCaption: function TableCaption({
    ...
    return (
      <caption {...withSlot("table-caption", { className, ...props })}>
        {children}
      </caption>
    )
  },
...
export const tooltipMock = {
  ...
  TooltipTrigger: function TooltipTrigger({
    ...
    return (
      <button {...withSlot("tooltip-trigger", { className, ...props })}>
        {children}
      </button>
    )
  },
  TooltipContent: function TooltipContent({
    ...
    return (
      <div
        role="tooltip"
        {...withSlot("tooltip-content", { className, ...props })}
      >
        {children}
      </div>
    )
