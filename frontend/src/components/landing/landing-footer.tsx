      ...
      <Wrap>
        <div className="grid grid-cols-[1.6fr_repeat(4,1fr)] gap-8 max-[980px]:grid-cols-2">
          ...
          <div>
            ...
            <a href="#" className={COL_LINK}>Exercise library</a>
            <a href="#" className={COL_LINK}>Program templates</a>
            <a href="#" className={COL_LINK}>Coaching guide</a>
            <a href="#" className={COL_LINK}>Changelog</a>
          </div>
          <div>
            <h4 className="mb-[0.875rem] text-[0.8125rem] font-semibold tracking-[0.01em]">Company</h4>
            <a href="#" className={COL_LINK}>About</a>
            <a href="#" className={COL_LINK}>Blog</a>
            <a href="#" className={COL_LINK}>Careers</a>
            <a href="#" className={COL_LINK}>Contact</a>
          </div>
          <div>
            <h4 className="mb-[0.875rem] text-[0.8125rem] font-semibold tracking-[0.01em]">Legal</h4>
            <a href="#" className={COL_LINK}>Privacy</a>
            <a href="#" className={COL_LINK}>Terms</a>
            <a href="#" className={COL_LINK}>Security</a>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-4 pt-6">
          ...
          <span className="flex gap-5">
            <a href="#" className={LEGAL_LINK}>Privacy</a>
            <a href="#" className={LEGAL_LINK}>Terms</a>
            <a href="#" className={LEGAL_LINK}>Status</a>
          </span>
        </div>
      </Wrap>
    </footer>
