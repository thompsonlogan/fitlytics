...
// Placeholder destinations are rendered as non-interactive text rather than
// dead href="#" links (which trap keyboard users and scroll to top). The
// in-page anchors (#top, #tracking, …) and the /today Link are real and stay
// as links. Swap a placeholder to a <Link>/<a href> once its page exists.
const SOCIAL = "inline-flex size-8 items-center justify-center rounded-md border border-border text-muted-foreground [&_svg]:size-4"
const COL_LINK = "block py-[0.3125rem] text-sm text-muted-foreground transition-colors hover:text-foreground"
const COL_TEXT = "block py-[0.3125rem] text-sm text-muted-foreground"
const LEGAL_TEXT = "text-[0.8125rem] text-muted-foreground"
      ...
      <Wrap>
        <div className="grid grid-cols-[1.6fr_repeat(4,1fr)] gap-8 max-[980px]:grid-cols-2">
          <div className="max-[980px]:col-span-full">
            ...
            <div className="mt-5 flex gap-2">
              <span aria-label="X" className={SOCIAL}>
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231 5.45-6.231Zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77Z" />
                </svg>
              </span>
              <span aria-label="Instagram" className={SOCIAL}>
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
              ...
              <span aria-label="YouTube" className={SOCIAL}>
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span aria-label="GitHub" className={SOCIAL}>
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          <div>
            ...
            <span className={COL_TEXT}>Exercise library</span>
            <span className={COL_TEXT}>Program templates</span>
            <span className={COL_TEXT}>Coaching guide</span>
            <span className={COL_TEXT}>Changelog</span>
          </div>
          <div>
            <h4 className="mb-[0.875rem] text-[0.8125rem] font-semibold tracking-[0.01em]">Company</h4>
            <span className={COL_TEXT}>About</span>
            <span className={COL_TEXT}>Blog</span>
            <span className={COL_TEXT}>Careers</span>
            <span className={COL_TEXT}>Contact</span>
          </div>
          <div>
            <h4 className="mb-[0.875rem] text-[0.8125rem] font-semibold tracking-[0.01em]">Legal</h4>
            <span className={COL_TEXT}>Privacy</span>
            <span className={COL_TEXT}>Terms</span>
            <span className={COL_TEXT}>Security</span>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-4 pt-6">
          ...
          <span className="flex gap-5">
            <span className={LEGAL_TEXT}>Privacy</span>
            <span className={LEGAL_TEXT}>Terms</span>
            <span className={LEGAL_TEXT}>Status</span>
          </span>
        </div>
      </Wrap>
    </footer>
