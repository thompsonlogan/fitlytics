...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&generated.User{})
...
func (u userDo) Create(values ...*generated.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*generated.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*generated.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*generated.User, error) {
...
func (u userDo) Take() (*generated.User, error) {
...
func (u userDo) Last() (*generated.User, error) {
...
func (u userDo) Find() ([]*generated.User, error) {
	result, err := u.DO.Find()
	return result.([]*generated.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*generated.User, err error) {
	buf := make([]*generated.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*generated.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*generated.User, error) {
...
func (u userDo) FirstOrCreate() (*generated.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*generated.User, count int64, err error) {
...
func (u userDo) Delete(models ...*generated.User) (result gen.ResultInfo, err error) {
